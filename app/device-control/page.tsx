...
function DeviceCard({
  ...
  return (
    <motion.div
      ...
      whileHover={{ y: -4 }}
    >
      <Card className="relative h-full rounded-2xl border border-white/10 overflow-hidden shadow-xl bg-gradient-to-br from-[#1a2332]/80 to-[#0f1419]/80 backdrop-blur-sm group">
        <div
    ...
    <div className="space-y-2">
      ...
      <div className="flex items-center gap-3">
        <input
          ...
          className="flex-1 h-2 rounded-full appearance-none cursor-pointer bg-white/10 [&::-webkit-slider-thumb]:appearance-none [&::-webkit-slider-thumb]:w-4 [&::-webkit-slider-thumb]:h-4 [&::-webkit-slider-thumb]:rounded-full [&::-webkit-slider-thumb]:bg-white [&::-webkit-slider-thumb]:cursor-pointer [&::-webkit-slider-thumb]:shadow-lg [&::-webkit-slider-thumb]:transition-transform [&::-webkit-slider-thumb]:hover:scale-110"
          style={{
      ...
      <div className="grid grid-rows-[72px_1fr] h-full w-full">
        ...
        <div className="relative px-8 pb-8 pt-6 overflow-auto">
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_440px] gap-6 h-full">
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <DeviceCard
                  title="水泵 (Relay 5)"
                  icon={
                    <Droplet className="size-16 text-white" strokeWidth={1.5} />
                  }
                ...
                <DeviceCard
                  title="补光灯 (Relay 7)"
                  icon={<Lightbulb className="size-16 text-white" strokeWidth={1.5} />}
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <DeviceCard
                  title="白灯 (Relay 8)"
                  icon={<Sun className="size-16 text-white" strokeWidth={1.5} />}
                      ...
                      <div className="flex flex-col md:flex-row items-center gap-8">
                        <div className="flex-1 space-y-4">
                          <div>
                            <Badge
                              variant="outline"
                              className="bg-white/10 text-white/90 border-white/20 backdrop-blur-sm mb-3"
                            >
                              RGB 控制 (LED 1-3)
                            </Badge>
                          ...
                          <div
                            className="w-full h-24 rounded-xl border border-white/20 shadow-inner transition-all duration-300"
                            style={{
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <DeviceCard
                  title="CO₂ 传感器"
                  icon={<Wind className="size-16 text-white" strokeWidth={1.5} />}
            ...
            <div className="h-full rounded-2xl bg-gradient-to-br from-[#0f1419]/80 to-[#0a0e14]/80 backdrop-blur-sm border border-white/10 shadow-2xl overflow-auto p-6">
