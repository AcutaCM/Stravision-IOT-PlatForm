...
export function ScheduledTasksList() {
  ...
  if (tasks.length === 0) {
    return (
      <div className="my-4 bg-gray-50 rounded-2xl p-8 border border-gray-100 flex flex-col items-center justify-center text-center">
        <div className="size-12 bg-white rounded-full shadow-sm flex items-center justify-center mb-3 text-gray-300">
           <Calendar size={24} />
        </div>
        <h3 className="text-gray-900 font-medium mb-1">暂无定时任务</h3>
        <p className="text-sm text-gray-500">您可以让 AI 帮您设定，例如"每天8点开启水泵"</p>
      </div>
    )
  }
        ...
        {tasks.map((task) => {
          ...
          return (
            <motion.div
              ...
              className="group bg-white rounded-xl border border-gray-100 shadow-sm hover:shadow-md transition-all overflow-hidden relative"
            >
              <div className={cn(
                "absolute left-0 top-0 bottom-0 w-1",
                task.is_active ? "bg-blue-500" : "bg-gray-300"
              )} />
              ...
              <div className="p-4 flex items-center gap-4">
                 ...
                 <div className={cn(
                   ...
                   task.is_active ? "bg-blue-50 text-blue-600" : "bg-gray-100 text-gray-400"
                 )}>
                    ...
                    <div className="flex items-center gap-3 text-xs text-gray-500">
                       ...
                       <div className="flex items-center gap-1">
                          ...
                          <span>
                            ...
                            <span className={cn("ml-1 font-medium", isOn ? "text-green-600" : "text-red-500")}>
